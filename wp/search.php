   ...
   <form action="" method="post">
      ...
      <h3>Filter Your Search</h3>
         ...
         <div class="flex">
            ...
            <div class="box">
               <p>Minimum Budget</p>
               <input type="number" name="min" required maxlength="100" placeholder="Amount in CAD" class="input">
            </div>
            <div class="box">
               <p>Maximum budget</p>
               <input type="number" name="max" required maxlength="100" placeholder="Amount in CAD" class="input">
               </select>
            </div>
            <div class="box">
               <p>Status</p>
