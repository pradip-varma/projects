   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="box">
            ...
            <input type="number" name="age" required min="0" max="99" maxlength="2" placeholder="How Old Property is ?" class="input">
         </div>
         <div class="box">
            <p>Total Floors <span>*</span></p>
            <input type="number" name="total_floors" required min="0" max="99" maxlength="2" placeholder="How Many Floors ?" class="input">
         </div>
         <div class="box">
